...
class RepoTests(unittest.TestCase):
    ...
    def test_reject_missing_local_module(self):
        ...
        with self.assertRaises(Invalid):checks(self.root)
    def test_bundled_keymap_matches_agreed(self):
        self.assertEqual(keymap_info(ROOT/'reference/previous-five-layer.keymap')[3],keymap_info(ROOT/'config/modu.keymap')[3])
