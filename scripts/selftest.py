...
from package_firmware import PackageError, package_firmware as _package_firmware

# Retain the original three-target packaging regression fixtures.
# The six-target matrix has additional tests in test_full_config.py.
def package_firmware(*args, **kwargs):
    return _package_firmware(*args, targets=("modu_left", "modu_right", "settings_reset"), **kwargs)
